 ...
 implements servidorAlertas.sop_corba.IPatientManagementOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("selectAllPatients", new java.lang.Integer (4));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 4:  // sop_corba/IPatientManagement/selectAllPatients
       {
         String $result[] = null;
       ...
       case 5:  // sop_corba/IPatientManagement/sendIndicators
       {
         ...
         boolean $result = false;
         $result = this.sendIndicators (roomId, indicators);
         out = $rh.createReply();
         out.write_boolean ($result);
         break;
       }
